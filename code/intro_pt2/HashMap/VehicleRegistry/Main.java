...
public class Main
{
    public static void main(String[] args) {
        ...
        vehicleRegistry.add(li2, "Jurgen");
        vehicleRegistry.add(li3, "Jurgen");

        System.out.println(vehicleRegistry.add(li2, "Bean Curd"));

        System.out.println(vehicleRegistry.get(li1));
        System.out.println(vehicleRegistry.get(li3));
        System.out.println(vehicleRegistry.remove(li3));
